...
public class Utilidades {
    ...
    public static int calculoPuntos(Equipos e1) {//SE CALCULA EL PUNTAJE
        int puntos;
        puntos = e1.getPartidosGanados() * 3 + e1.getPartidosEmpatados() * 1;
        return puntos;
    }

    public static int calcularDiferenciGol(Equipos e1) {//SE CALCULA LA DIFERENCIA DE GOL
        int diferenciaGol;
        diferenciaGol = e1.getGolesFavor() - e1.getGolesContra();
        return diferenciaGol;
    }

    public static void mostrarResultados(Equipos e1) {//MOSTRAR RESULTADO DE PUNTOS Y DIFERENCIA DE GOL
    ...
    public static void mostrarPosicionesFinales(ArrayList<Equipos> listaFinal) {//MOSTRAR TABLA DE POSICIONES FINAL
